...
namespace Projekt.Intranet.Controllers
{
    public class StronaController : Controller
    {
        ...
        public StronaController(FormaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdStrony,LinkTytul,Tytul,PodTytul,FotoURL,Pozycja,Icon")] Strona strona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStrony,LinkTytul,Tytul,PodTytul,FotoURL,Pozycja,Icon")] Strona strona)
        {
